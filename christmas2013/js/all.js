...
$(document).ready(function() {
	...
	// 		} else {
	// 			return true;
	// 			// if (location.hash.indexOf('microsoft') != -1) {
	// 			// 	location.href = 'https://www.muzik-online.com/listen/theme/3e1ad682-e53c-b793-087e-df2498305b0c';
	// 			// } else {
	// 			// 	location.href = "https://www.muzik-online.com/listen/" + member.category_name + "/" + member.member_uuid;
	// 			// }
	// 		}
	// 	});
	// });
...
function sendAjax(obj, handleData) {
	var result="";
	jQuery.ajax({
		url: 'action.php',
		type: 'POST',
